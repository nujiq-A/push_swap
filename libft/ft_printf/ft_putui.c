...
/*   Updated: 2023/12/13 17:12:47 by qang             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	s_putui3(unsigned int n, int *count, t_flag *flags, size_t len);
...
static void	s_putui4(unsigned int n, int *count, t_flag *flags, size_t len)
{
	size_t	prec;
