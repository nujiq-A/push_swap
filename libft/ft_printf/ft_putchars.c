...
/*   Updated: 2023/12/13 17:11:26 by qang             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	s_putstr4(char *str, int *count, t_flag *flags, size_t len)
{
	if (flags->justify)
	{
		while (*str)
...
static void	s_putstr3(char *str, int *count, t_flag *flags)
{
	size_t	prec;
