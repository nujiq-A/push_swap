...
/*   Updated: 2023/12/13 17:10:53 by qang             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	s_putaddr3(uintptr_t addy, int *count, t_flag *flags, size_t i)
{
	size_t	prec;
...
static void	s_putaddr2(uintptr_t addy, int *count, t_flag *flags, size_t i)
{
	size_t	prec;
